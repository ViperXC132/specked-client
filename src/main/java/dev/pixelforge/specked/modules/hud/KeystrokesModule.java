...
public class KeystrokesModule extends Module {
    ...
    private void drawKey(DrawContext ctx, String label, int x, int y, boolean pressed) {
        ...
        ctx.fill(x, y + 11, x + w, y + 12, 0x44FFFFFF);
        ctx.fill(x, y, x + 1, y + 12, 0x44FFFFFF);
        ctx.fill(x + w - 1, y, x + w, y + 12, 0x44FFFFFF);
        ctx.drawCenteredTextWithShadow(mc.textRenderer, label, x + w / 2, y + 2, textColor);
    }
}
